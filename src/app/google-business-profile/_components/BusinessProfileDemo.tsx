...
export function BusinessProfileDemo() {
  ...
  return <div ref={ref} className="gbp-demo" data-phase={phase} data-running={running} role="group" aria-label="Aperçu illustratif d’une fiche Google Business Profile">
    <div className="gbp-demo-window"><div className="gbp-demo-top"><Image src="/brands/google-color.svg" alt="Google" width={24} height={24}/><strong>Votre fiche d’établissement</strong><small>Démonstration</small></div>
      <div className="gbp-demo-profile"><div className="gbp-demo-photo"><Image src="/blog/photos/commerce-disquaire.webp" alt="Photographie d’illustration : les rayons d’un magasin de disques" fill sizes="(max-width:560px) 80px, 260px"/><span><Camera aria-hidden="true"/>Photo réelle d’illustration</span></div><div className="gbp-demo-identity"><span className="gbp-demo-category">Commerce de proximité</span><div className="seo-visual-title">Votre établissement</div><p>Votre activité, présentée avec soin.</p><div className="gbp-demo-actions" aria-label="Exemples d’actions de la fiche"><span><Globe2 aria-hidden="true"/>Site web</span><span><Phone aria-hidden="true"/>Appeler</span><span><MapPin aria-hidden="true"/>Itinéraire</span></div></div></div>
