...
<html lang="fr"><head><meta charset="utf-8"><meta name="viewport" content="width=device-width,initial-scale=1"><meta name="robots" content="noindex,follow"><title>Prestation retirée | Litus</title>
...
<body><main><header><img src="/logo-sans-fond.png" width="40" height="45" alt="">Litus</header><small>410 · CONTENU RETIRÉ</small><h1>Cette prestation n’est plus proposée.</h1><p>Cette ancienne page a été retirée définitivement. Retrouvez nos prestations actuelles ou échangez avec notre équipe pour identifier la solution adaptée à votre projet.</p><nav aria-label="Continuer sur le site"><a href="/expertise">Découvrir nos expertises</a><a href="/contact">Contacter Litus</a></nav></main></body></html>`
