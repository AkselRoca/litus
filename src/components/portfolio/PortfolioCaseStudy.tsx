    ...
    <article className="portfolio-case" style={{ '--project-tone': story.tone, '--project-accent': story.accent } as CSSProperties}>
      <div className="portfolio-container">
        ...
        <section className="portfolio-case-scope" aria-labelledby="project-scope">
          ...
          <div className="portfolio-case-scope-copy"><p>{story.scope}</p>{story.scopeOnly && <p className="portfolio-case-scope-note">Les visuels présentent l’univers du site client. Ils illustrent ce contexte, sans attribuer à Litus la création de l’ensemble du site ou de l’identité de marque.</p>}{story.sourceUrl && <a href={story.sourceUrl} target="_blank" rel="noopener noreferrer" className="portfolio-explore">Explorer le site client <ArrowUpRight size={17} aria-hidden="true" /><span className="sr-only"> (nouvel onglet)</span></a>}</div>
        </section>
