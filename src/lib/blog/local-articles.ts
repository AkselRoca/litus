...
<li><a href="https://support.google.com/business/answer/3038177?hl=fr">Google — Consignes de représentation d’un établissement</a></li>
  ...
  },
  {
    ...
    coverImage: '/realisations/demetis-website.webp', coverImageAlt: 'Capture de la page d’accueil du site Demétis Immo, agence immobilière au Mans',
    coverImageCredit: { label: 'Capture du site Demétis Immo · Illustration de site web', href: '/realisations/demetis-immo' },
    content: `
