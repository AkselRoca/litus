export type ExpertiseSlug = 'nextjs' | 'react' | 'typescript' | 'tailwind' | 'framer' | 'vercel' | 'stripe' | 'shopify' | 'wordpress' | 'python' | 'csharp' | 'dotnet' | 'labview' | 'google-workspace' | 'gemini' | 'google-ads' | 'meta-ads' | 'make' | 'notion' | 'brevo' | 'hubspot' | 'airtable' | 'microsoft-365' | 'microsoft-copilot' | 'n8n' | 'zapier' | 'webflow' | 'openai' | 'claude' | 'codex'
