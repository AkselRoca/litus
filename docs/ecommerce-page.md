...
- Logos officiels Shopify et WooCommerce, sans modification de leurs tracés. Les visuels de plateforme sont identifiés comme tels, distincts de la réalisation Litus Japan Hunter.
...
- Tous les liens internes du nouveau contenu répondent HTTP 200, dont `/realisations/japan-hunter` et le lien Contact avec contexte.
